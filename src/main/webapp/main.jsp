...
%>
	...
	if(btn.equals("Guardar Proyecto")){
		...
		concatenar = "Nombre: " +request.getParameter("nombreProyecto")+"<br>"+ "Duracion: "+ request.getParameter("duracionProyecto")+"<br>"+ "Plataformas: "+ request.getParameter("plataformasDesarrollo");
		...
		out.println("<br>"+"Codigo: " +request.getParameter("buscaProyecto")+ "<br>" +datos.get(codigos.indexOf(request.getParameter("buscaProyecto"))));
	}
